...
export default function JobFormPage() {
  ...
  const validateStep = (step: number) => {
    ...
    if (step === 2) {
      ...
      if (!formData.preferLocation.trim())
        newErrors.preferLocation = "Preferred Location is required";
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // validate last step explicitly
    if (!validateStep(4)) return;

    if (!formData.declaration || !formData.authorized) {
      toast({
        title: "Declarations Required",
        description: "Please accept the declarations before submitting.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      await apiClient.post("/applications/job", formData);

      toast({
        title: "Application Submitted!",
        description: "We have received your job application.",
      });
    ...
    <>
              ...
              <div className="bg-background p-8 rounded-2xl shadow-sm border">
                <div className="mb-8">
                  ...
                  <p className="text-muted-foreground">
                    Please fill out the details for the current section.
                  </p>
                </div>
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                          <Label
                            htmlFor="age"
                            className={cn(errors.age && "text-destructive")}
                          >
                            Age
                          </Label>
                          <Input
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="space-y-2">
                          <Label
                            htmlFor="zip"
                            className={cn(errors.zip && "text-destructive")}
                          >
                            ZIP Code
                          </Label>
                          <Input
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                          <Label
                            ...
                            className={cn(
                              errors.expectedSalary && "text-destructive"
                            )}
                          >
                            Expected Salary (PA)
                          </Label>
                          <Input
                            ...
                            onChange={handleInputChange}
                            className={cn(
                              errors.expectedSalary && "border-destructive"
                            )}
                          />
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          <Label
                            htmlFor="experience"
                            className={cn(
                              errors.experience && "text-destructive"
                            )}
                          >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                          <Label
                            ...
                            className={cn(
                              errors.preferLocation && "text-destructive"
                            )}
                          >
                            Prefer Location
                          </Label>
                          <Input
                            ...
                            onChange={handleInputChange}
                            className={cn(
                              errors.preferLocation && "border-destructive"
                            )}
                          />
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2">
                              <Label
                                htmlFor="percentage"
                                className={cn(
                                  errors.percentage && "text-destructive"
                                )}
                              >
                                Percentage / CGPA
                              </Label>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2">
                              <Label
                                htmlFor="aadhaar"
                                className={cn(
                                  errors.aadhaar && "text-destructive"
                                )}
                              >
                                Aadhaar Card Number
                              </Label>
                            ...
                            <div className="space-y-2">
                              <Label
                                htmlFor="uan"
                                className={cn(errors.uan && "text-destructive")}
                              >
                                UAN No
                              </Label>
                              <Input
                  ...
                  {currentStep === 4 && (
                    <Card>
                      <CardHeader>
                        <CardTitle>Payment & Declaration</CardTitle>
                      </CardHeader>
                      <CardContent className="space-y-6">
                        {/* Application Fee Card */}
                        <div
                          className="flex flex-col gap-4 p-4 bg-muted rounded-lg border
                  sm:flex-row sm:items-center sm:justify-between"
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          >
                            ...
                            knowledge. I further acknowledge that this
                            application is submitted solely for the purpose of
                            registration and screening, and does not guarantee
                            employment or constitute a job offer.
                          </Label>
                        </div>
                      </CardContent>
                    </Card>
      ...
      {show && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
          {/* Modal box */}
          <div className="bg-white rounded-xl flex flex-col items-center justify-center shadow-lg p-6 relative w-[75%] md:w-[30%] max-w-md">
            {/* Close button */}
            <button
