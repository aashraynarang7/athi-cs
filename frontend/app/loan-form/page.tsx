...
const initialFormData = {
  ...
  country: "India",
  position: "",
  employmentDate: undefined as Date | undefined,
  employmentType: "",
  monthlyIncome: "",
  otherIncome: "",
  loanAmount: "",
...
export default function LoanFormPage() {
  ...
  const validateStep = (step: number) => {
    ...
    if (step === 4) {
      ...
      } else if (!upiTxnRegex.test(formData.transactionId)) {
        newErrors.transactionId =
          "Invalid UPI Transaction ID (must be exactly 12 digits)";
      }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await apiClient.post("/applications/loan", formData);
              ...
              <div className="bg-background p-8 rounded-2xl shadow-sm border">
                <div className="mb-8">
                  ...
                  <p className="text-muted-foreground">
                    Please provide the required information for this section.
                  </p>
                </div>
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                          <Label
                            htmlFor="pan"
                            className={cn(errors.pan && "text-destructive")}
                          >
                            PAN No
                          </Label>
                          <Input
                            ...
                            value={formData.pan}
                            onChange={handleInputChange}
                            className={cn(errors.pan && "border-destructive")}
                            maxLength={10}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                          <Label
                            htmlFor="gender"
                            className={cn(errors.gender && "text-destructive")}
                          >
                            Gender
                          </Label>
                          <Select
                      ...
                      <div className="space-y-2">
                        <Label
                          ...
                          className={cn(
                            errors.maritalStatus && "text-destructive"
                          )}
                        >
                          Marital Status
                        </Label>
                    ...
                    <div className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          <Label
                            htmlFor="contact"
                            className={cn(errors.contact && "text-destructive")}
                          >
                            Contact Number
                          </Label>
                          <Input
                      ...
                      <div className="space-y-2">
                        <Label
                          htmlFor="aadhaar"
                          className={cn(errors.aadhaar && "text-destructive")}
                        >
                          Aadhaar Card
                        </Label>
                        <Input
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                          <Label
                            htmlFor="postalCode"
                            className={cn(
                              errors.postalCode && "text-destructive"
                            )}
                          >
                            Postal Code
                          </Label>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <BetterDatePicker
                          ...
                          onChange={(date) =>
                            handleDateChange("employmentDate", date)
                          }
                          fromYear={1980}
                          toYear={2024}
                        ...
                        <div className="space-y-2">
                          <Label
                            ...
                            className={cn(
                              errors.employmentType && "text-destructive"
                            )}
                          >
                            Employment Type
                          </Label>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          <Label
                            ...
                            className={cn(
                              errors.monthlyIncome && "text-destructive"
                            )}
                          >
                            Monthly Income
                          </Label>
                  ...
                  {currentStep === 4 && (
                    <div className="space-y-6">
                      <Card>
                        <CardHeader>
                          <CardTitle>Loan & Nominee Details</CardTitle>
                        </CardHeader>
  ...
  <div className="space-y-2">
    <Label
      htmlFor="loanAmount"
      className={cn(errors.loanAmount && "text-destructive")}
    >
  ...
  <div className="space-y-2">
    <Label
      htmlFor="loanPurpose"
      className={cn(errors.loanPurpose && "text-destructive")}
    >
      Purpose of Loan
    </Label>
    <Select
      ...
      onValueChange={(value) =>
        handleSelectChange("loanPurpose", value)
      }
    >
      <SelectTrigger
        className={cn(
          "h-11",
          errors.loanPurpose && "border-destructive"
        )}
      >
  ...
  <div className="space-y-2">
    <Label
      htmlFor="nomineeName"
      className={cn(errors.nomineeName && "text-destructive")}
    >
      Nominee Name
    </Label>
    <Input
      ...
      className={cn(
        "h-11",
        errors.nomineeName && "border-destructive"
      )}
    />
    {errors.nomineeName && (
      <p className="text-sm text-destructive">{errors.nomineeName}</p>
    )}
  </div>

  {/* Nominee Contact + Aadhaar */}
  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
    <div className="space-y-2">
      <Label
        htmlFor="nomineeContact"
        className={cn(errors.nomineeContact && "text-destructive")}
      >
        Nominee Contact
      </Label>
      <Input
        ...
        className={cn(
          "h-11",
          errors.nomineeContact && "border-destructive"
        )}
      />
    ...
    <div className="space-y-2">
      <Label
        htmlFor="nomineeAadhaar"
        className={cn(errors.nomineeAadhaar && "text-destructive")}
      >
        Nominee Aadhaar
      </Label>
      <Input
        ...
        className={cn(
          "h-11",
          errors.nomineeAadhaar && "border-destructive"
        )}
      />
    ...
    {errors.transactionId && (
        ...
        {errors.transactionId}
                      ...
                      <div className="flex items-start space-x-3 pt-4">
                        <Checkbox
                          ...
                          onCheckedChange={(c) =>
                            handleCheckboxChange("declaration", c as boolean)
                          }
                        />
                        <Label
                          htmlFor="declaration"
                        ...
                        >
                          ...
                          I further acknowledge that this application is
                          submitted solely for the purpose of loan assessment
                          and eligibility screening, and does not guarantee loan
                          approval or constitute a sanction or disbursement.
                        </Label>
                      </div>
                    </div>
                  )}
      ...
      {show && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
          {/* Modal box */}
          <div className="bg-white rounded-xl flex flex-col items-center justify-center shadow-lg p-6 relative w-[75%] md:w-[30%] sm:w-[70%] max-w-md">
            {/* Close button */}
            <button
            ...
            {/* Image */}
            <div className=" bg-background p-2 rounded-2xl shadow-sm border">
              <img
                src="/QRcode2.png"
                alt="Payment Info"
            ...
            <div className="mt-3 flex justify-center">
              <Button
                onClick={() => {
                  setShow(false);
                  // optional: trigger payment directly
                  // handlePayment(new Event("submit") as any)
                  setTimeout(() => {
